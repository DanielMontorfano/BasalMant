...
-webkit-text-fill-color: transparent;">Crear un nuevo repuesto</h6>
@stop
@section('content')
                ...
                <div class="col col-md-8">
                    ...
                    <form id="nuevoRepuesto"  action="{{route('repuestos.store')}}" method="POST" class="form-horizontal" STYLE="background: linear-gradient(to right,#495c5c,#030007);">
                        ...
                        <div class="container">
                            ...
                            <div class="row"> {{-- ***** div de la primera fila --}}
                              ...
                              <div class="col col-md-3"> {{-- ***** div de la primera fila --}}
                                <div class="form-group">
                                  ...
                                  <input autocomplete="off" placeholder="Ej.: 6914 0035" class="form-control" style="color: #f2baa2;" type="text" name="codigo" value={{old('codigo')}}> 
                                  @error('codigo')
                                 <small>*{{$message}}</small>
                                  @enderror
                                </div>
                            ...
                            <br>
                           <div class="form-group">
                            <button form="nuevoRepuesto" class="btn btn-primary" type="submit" STYLE="background: linear-gradient(to right,#495c5c,#030007);">Enviar</button>
