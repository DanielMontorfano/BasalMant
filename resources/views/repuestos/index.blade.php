     ...
     <table class="table table-sm" STYLE="background: linear-gradient(to right,#495c5c,#030007);" >
        <tr>
          <div class="form-group">
            ...
            <td><input type="text" class='form-control' value="{{ old('search') }}" name="search" id="search" autocomplete="off" placeholder="Buscar repuesto (Ej.: rodamiento, manguito, rele, 7984 2305 )" STYLE="color: #f2baa2; font-family: Times New Roman;  font-size: 18px; background: linear-gradient(to right,#030007, #495c5c);"> </td>
          </div>  
